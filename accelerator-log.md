...
```json
{
  ...
  "databasePostgresStorageClass" : "standard-rwo",
  ...
  "projectName" : "cro-java-rest-service",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol databaseResourceName with value 'customer-database'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol databasePostgresStorageClassResourceName with value 'standard-rwo'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [storage-class-standard->standard-rwo, customer-database->customer-database, databasename->customer-database]
